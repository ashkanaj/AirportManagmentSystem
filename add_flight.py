...
class ADD_FLIGHT:
    ...
    def view(self):
        ...
        lbl_Flight_number = Label(Create_Flight_Frame, text="Flight Number", font=("Goudy old style", 15, "bold"),
                                  fg="black", bg="white")
        ...
        lbl_seats = Label(Create_Flight_Frame, text="Total Seats", font=("Goudy old style", 15, "bold"), fg="black",
                          bg="white")
        ...
        lbl_avaliable_seats = Label(Create_Flight_Frame, text="Availiable Seats", font=("Goudy old style", 15, "bold"),
                                    fg="black", bg="white")
        ...
        lbl_arrival_time = Label(Create_Flight_Frame, text="Arrival Time", font=("Goudy old style", 15, "bold"),
                                 fg="black", bg="white")
        ...
        lbl_departure_time = Label(Create_Flight_Frame, text="Departure Time", font=("Goudy old style", 15, "bold"),
                                   fg="black", bg="white")
        ...
        def submit():
            ...
            if BlackFlag1 == False and BlackFlag2 == False and BlackFlag3 == False and BlackFlag4 == False and BlackFlag5 == False and BlackFlag6 == False:
                if int(Seats) >= int(Seats_Availiable):
                    ...
                    obj.Insert_data_flights(Airline_Name, Flight_number, int(Seats), int(Seats_Availiable),
                                            Location_From, Location_To, Departure_time_obj, Arrival_time_obj,
                                            created_time)
                    tkMessageBox.showwarning('', 'Flight Created!', icon="warning", parent=Create_Flight_Frame)
                    close()
                else:
                    tkMessageBox.showwarning('', 'The Avaliable Seats cannot be more then Total Seats!', icon="warning",
                                             parent=Create_Flight_Frame)

            else:
                tkMessageBox.showwarning('', 'Looks Like Some Data is Missing .!', icon="warning",
                                         parent=Create_Flight_Frame)

        time_label = Label(Create_Flight_Frame, text='The Time Format must be 24Hour', bg="white", fg="black",
                           font=("times new roman", 11))
        time_label.place(x=90, y=500)
        submit_btn = Button(Create_Flight_Frame, text="Submit", command=submit, bg="white", fg="black",
